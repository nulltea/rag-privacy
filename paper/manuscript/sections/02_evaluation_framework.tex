...
\citep{cheng2025remoterag}), or ciphertexts plus distance structure (Caprise's
...
\begin{table*}[t]
  ...
  \begin{tabular}{@{}lllllll@{}}
    ...
    PermLLM      & HbC        & non-coll.\ 3PC & wb   & input        & shares       & crypto+heur. \\
    RemoteRAG    & HbC        & none           & ---  & query        & query+ap     & DP \\
    Caprise      & HbC        & none           & ---  & doc+query    & ct+dist      & crypto*+DP \\
    Pacmann      & HbC        & none (PIR)     & ---  & query+access & none (pub.\ DB) & crypto \\
